    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 pb-20">
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center z-10">
          ...
          >
            <span className="text-[10px] sm:text-[12px] font-bold uppercase tracking-[0.4em] text-orange-700">Called to Serve • Proclaiming Christ Across India</span>
          </div>
            ...
            <div className="reveal order-1 lg:order-2">
              ...
              <ul className="space-y-4 mb-12">
                {["12 Active Discipleship Centers", "Vocational Training for Widows", "Orphanage Support Programs"].map((item, i) => (
                  <li key={i} className="flex items-center space-x-4 text-slate-700 font-bold serif italic">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-12 text-center relative z-10">
          {[
            ...
            <div key={i} className="group reveal" style={{ transitionDelay: `${i * 0.15}s` }}>
              <div className={`text-4xl sm:text-6xl font-black mb-4 serif ${stat.color} group-hover:scale-110 transition-transform duration-700`}>
                {stat.val}
              </div>
              <div className="text-[10px] sm:text-[12px] text-slate-400 font-bold uppercase tracking-[0.3em]">
                {stat.label}
              </div>
            </div>
          ))}
